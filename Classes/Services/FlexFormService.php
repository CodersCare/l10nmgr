...
class FlexFormService
{
     ...
     * @throws AbstractInvalidDataStructureException
     */
    public function traverseFlexFormXMLData(string $table, string $field, array $row, object $callBackObj, string $callBackMethod_value): bool|string
    {
        $PA = [];
     ...
     */
    public function traverseFlexFormXMLData_recurse(array $dataStruct, array $editData, array &$PA, string $path = ''): void
    {
     ...
     */
    protected function executeCallBackMethod(string $methodName, array $parameterArray): mixed
    {
    ...
    public function flexArray2Xml(array $array): string
    {
        ...
        return '<?xml version="1.0" encoding="utf-8" standalone="yes" ?>' . PHP_EOL .
