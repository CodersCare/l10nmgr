...
class ConfigurationModuleController
{
    ...
    protected function renderConfigurationDetails(array $configuration): string
    {
        ...
        $details .= '<td>' . ((empty($languageArray['lg_name_en'])) ? $this->getLanguageService()->sL($this->lll . 'general.list.infodetail.default') : htmlspecialchars($languageArray['lg_name_en'])) . '</td>';
        $details .= '</tr><tr class="db_list_normal">';
